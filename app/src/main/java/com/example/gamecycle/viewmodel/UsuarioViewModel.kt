package com.example.gamecycle.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.gamecycle.model.UsuarioDb
import com.example.gamecycle.model.UsuarioError
import com.example.gamecycle.model.UsuarioModel
...
class UsuarioViewModel(private val repository: UsuarioRepository): ViewModel() {
    private val _estado = MutableStateFlow(UsuarioModel())
    val estado : StateFlow<UsuarioModel> = _estado
